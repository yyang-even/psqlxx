...
class CommandGroup {
    ...
    public:
        ...
        const OptionAdder &operator()(Command::NameArrayType names,
                                      Command::NameArrayType arguments,
...
bool validCommand(const Command::NameArrayType &names,
                  const Command::NameArrayType &arguments,
                  const Command::ActionType action);

}//namespace internal

constexpr Command::ArgumentType VARIADIC_ARGUMENT = "...";
}//namespace psqlxx
